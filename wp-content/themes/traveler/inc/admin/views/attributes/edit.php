    ...
    <form action="" method="post">
        <table class="form-table">
            ...
            <tr class="form-field form-required">
                ...
                <td>
                    <input name="attribute_label" id="attribute_label" type="text" value="<?php echo esc_attr( $row['name'] ); ?>" />
            ...
            <tr class="form-field form-required">
                ...
                <td>
                    <input name="attribute_name" id="attribute_name" type="text" value="<?php echo esc_attr( $row['tax'] ); ?>" maxlength="28" />
