...
if(st_is_https()){
	$output .= "\n\t\t\t" . '<div class="tweets" data-tw_name="' . $twitter_name . '" data-tw_count="' . $tweets_count . '"></div> <p class="twitter_follow_button_wrap"><a class="wpb_follow_btn twitter_follow_button" href="https://twitter.com/' . $twitter_name . '">' . __( "Follow us on twitter", "js_composer" ) . '</a></p>';
}else{
