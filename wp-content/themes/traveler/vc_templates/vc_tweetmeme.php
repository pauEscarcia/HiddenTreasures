...
if(st_is_https()){
	$output = '<a href="https://twitter.com/share" class="' . $css_class . '" data-count="' . $type . '">' . __( "Tweet", "js_composer" ) . '</a><script type="text/javascript" src="https://platform.twitter.com/widgets.js"></script>' . $this->endBlockComment( 'tweetmeme' ) . "\n";
}else{
