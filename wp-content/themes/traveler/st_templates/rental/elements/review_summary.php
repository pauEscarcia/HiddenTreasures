...
<div class="booking-item-meta">
    ...
    <div class="booking-item-rating">
        ...
        <p><a class="text-default" href="<?php echo get_comments_link() ?>"><?php comments_number(st_get_language('no review'),st_get_language('rental_based_on_1_review'),st_get_language('based_on_s_review'));?></a>
        </p>
    </div>
