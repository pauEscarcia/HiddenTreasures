...
class st_widget_search_tour extends WP_Widget{
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'st_widget_search_tours', 'description' => __( "Tour Filter Box",STP_TEXTDOMAIN) );
        parent::__construct('st_widget_search_tour', __('ST Tour Filter Box',STP_TEXTDOMAIN), $widget_ops);
    ...
    public function form( $instance ) {
        ...
        <div class="st-search-fields">
            ...
            <a href="#" class="button st_add_field_tours" onclick="return false;"><?php _e('Add New',STP_TEXTDOMAIN)?></a>
            <a href="#" class="button st_save_fields_tours" onclick="return false;"><?php _e('Save List',STP_TEXTDOMAIN)?></a>
        </div>
