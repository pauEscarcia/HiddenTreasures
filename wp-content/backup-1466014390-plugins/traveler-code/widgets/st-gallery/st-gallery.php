...
class st_widget_list_gallery extends WP_Widget{
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_st_list_gallery', 'description' => __( "Your site&#8217;s list gallery.",STP_TEXTDOMAIN) );
        parent::__construct('st_widget_list_gallery', __('ST List Gallery',STP_TEXTDOMAIN), $widget_ops);
    ...
    public function form( $instance ) {
        ...
        <p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of Image to show:' ); ?></label>
