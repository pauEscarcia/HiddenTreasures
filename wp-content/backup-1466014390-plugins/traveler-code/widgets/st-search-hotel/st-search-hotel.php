...
class st_widget_search_hotel extends WP_Widget{
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'st_widget_search_hotel', 'description' => __( "Hotel Filter Box",STP_TEXTDOMAIN) );
        parent::__construct('st_widget_search_hotel', __('ST Hotel Filter Box',STP_TEXTDOMAIN), $widget_ops);
    ...
    function default_item($key=0,$old=array()){
        ...
        $fields='<select name="field['.$key.']" class="widefat field_name">
                        ...
                        <option '.selected('hotel_rate',$field,false).' value="hotel_rate">'.__('Star Rating',STP_TEXTDOMAIN).'</option>
                        <option '.selected('rate',$field,false).' value="rate">'.__('Review Score',STP_TEXTDOMAIN).'</option>
    ...
    public function form( $instance ) {
        ...
        <div class="st-search-fields">
            ...
            <a href="#" class="button st_add_field" onclick="return false;"><?php _e('Add New',STP_TEXTDOMAIN)?></a>
            <a href="#" class="button st_save_fields" onclick="return false;"><?php _e('Save List',STP_TEXTDOMAIN)?></a>
        </div>
