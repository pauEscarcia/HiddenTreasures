<?php
    if (!class_exists('ST_Section_Wrap_Start')) {
        class ST_Section_Wrap_Start extends WP_Widget
        {
            ...
            {
                $widget_ops = array('description' => __('Section Wrap Start'));
                parent::__construct(false, __('ST Section Wrap Start'), $widget_ops);
            }
            ...
            public function form($instance)
            {
                ...
                <p>
                    <label for="<?php echo $this->get_field_id('title_bg'); ?>"><?php _e('Title Background:') ?></label>
                    <input type="text" class="widefat" id="<?php echo $this->get_field_id('title_bg'); ?>"
                           name="<?php echo $this->get_field_name('title_bg'); ?>" value="<?php echo($title_bg); ?>"/>
                </p>
            <?php
            }
        }
