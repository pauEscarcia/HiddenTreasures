...
class st_widget_list_post extends WP_Widget{
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_st_list_entries', 'description' => __( "Your site&#8217;s list posts.",STP_TEXTDOMAIN) );
        parent::__construct('st_widget_list_post', __('ST List Posts',STP_TEXTDOMAIN), $widget_ops);
    ...
    public function widget($args, $instance) {
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Posts',STP_TEXTDOMAIN );
    ...
    public function form( $instance ) {
        ...
        <p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
            <label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Display post date?',STP_TEXTDOMAIN ); ?></label></p>

        <p>
            <label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php _e( 'Order By',STP_TEXTDOMAIN ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php _e( 'Order',STP_TEXTDOMAIN ); ?></label>
            <select name="<?php echo $this->get_field_name( 'order' ); ?>">
                <option <?php selected($orderby,"ASC");?> value="ASC"><?php echo __('ASC',STP_TEXTDOMAIN)?></option>
                <option <?php selected($orderby,"DESC");?> value="DESC"><?php echo __('DESC',STP_TEXTDOMAIN)?></option>
