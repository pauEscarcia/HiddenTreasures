...
if(!function_exists('st_thumbnail_cars_func'))
{
    ...
    add_shortcode('st_thumbnail_cars','st_thumbnail_cars_func');
}
...
if(!function_exists('st_excerpt_cars_func'))
{
    ...
    add_shortcode('st_excerpt_cars','st_excerpt_cars_func');
}
...
if(!function_exists('st_detail_date_location_cars_func'))
{
    function st_detail_date_location_cars_func()
    {
        ...
        {
            $default=array(
                'drop-off'=>__('none',STP_TEXTDOMAIN),
                'pick-up'=>__('none',STP_TEXTDOMAIN),
    ...
    add_shortcode('st_detail_date_location_cars','st_detail_date_location_cars_func');
}
...
add_shortcode('st_car_video','st_car_video');