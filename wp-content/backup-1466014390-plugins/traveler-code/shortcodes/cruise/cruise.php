...
add_shortcode('st_search_cruise_result','st_search_cruise_result');
add_shortcode('st_search_cruise_title','st_search_cruise_title');

add_shortcode('st_cruise_book_form','st_cruise_book_form');
add_shortcode('st_cruise_header','st_cruise_header');
add_shortcode('st_cruise_video','st_cruise_video');
add_shortcode('st_cruise_price','st_cruise_price');
add_shortcode('st_cruise_add_review','st_cruise_add_review');
add_shortcode('st_cruise_nearby','st_cruise_nearby');
add_shortcode('st_cruise_review','st_cruise_review');
add_shortcode('st_cruise_review_detail','st_cruise_detail_review_detail');
add_shortcode('st_cruise_review_summary','st_cruise_detail_review_summary');
add_shortcode('st_cruise_map','st_cruise_detail_map');
add_shortcode('st_cruise_programes','st_cruise_programes');

add_shortcode('st_cruise_search_cabins','st_cruise_search_cabins');
add_shortcode('st_cruise_list_cabins','st_cruise_list_cabins');
