    ...
    function st_hotel_add_review()
    {
        if(is_singular('st_hotel'))
        {
           return '<div class="text-right mb10">
                      <a class="btn btn-primary" href="'.get_comments_link().'">'.__('Write a review',STP_TEXTDOMAIN).'</a>
                   </div>';
        }
    }
}
...
add_shortcode('st_search_hotel_result','st_search_hotel_result');
add_shortcode('st_search_hotel_title','st_search_hotel_title');

add_shortcode('st_hotel_header','st_hotel_header');
add_shortcode('st_hotel_video','st_hotel_video');
add_shortcode('st_hotel_price','st_hotel_price');
add_shortcode('st_hotel_logo','st_hotel_logo');
add_shortcode('st_hotel_add_review','st_hotel_add_review');
add_shortcode('st_hotel_nearby','st_hotel_nearby');
add_shortcode('st_hotel_review','st_hotel_review');
add_shortcode('st_hotel_detail_list_rooms','st_hotel_detail_list_rooms');
add_shortcode('st_hotel_detail_card_accept','st_hotel_detail_card_accept');
add_shortcode('st_hotel_detail_search_room','st_hotel_detail_search_room');
add_shortcode('st_hotel_detail_review_detail','st_hotel_detail_review_detail');
add_shortcode('st_hotel_detail_review_summary','st_hotel_detail_review_summary');
add_shortcode('st_hotel_detail_map','st_hotel_detail_map');
