...
if(!function_exists('st_thumbnail_tours_func'))
{
    ...
    add_shortcode('st_thumbnail_tours','st_thumbnail_tours_func');
}
...
if(!function_exists('st_excerpt_tours_func'))
{
    ...
    add_shortcode('st_excerpt_tour','st_excerpt_tours_func');
}
...
if(!function_exists('st_tour_content_func'))
{
    ...
    add_shortcode('st_tour_content','st_tour_content_func');
}
...
if(!function_exists('st_info_tours_func'))
{
    ...
    add_shortcode('st_info_tours','st_info_tours_func');
}
...
add_shortcode('st_tour_program','st_tour_program');
...
add_shortcode('st_tour_share','st_tour_share');
...
add_shortcode('st_tour_nearby','st_tour_nearby');


add_shortcode('st_tour_video','st_tour_video');

add_shortcode('st_tour_price','st_tour_price');


add_shortcode('st_tour_review','st_tour_review');

add_shortcode('st_tour_detail_list_schedules','st_tour_detail_list_schedules');



add_shortcode('st_tour_detail_review_detail','st_tour_detail_review_detail');
add_shortcode('st_tour_detail_review_summary','st_tour_detail_review_summary');

add_shortcode('st_tour_detail_map','st_tour_detail_map');
