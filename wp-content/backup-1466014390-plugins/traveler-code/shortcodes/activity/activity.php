...
if(!function_exists('st_thumbnail_activity_func'))
{
    ...
    add_shortcode('st_thumbnail_activity','st_thumbnail_activity_func');
}
...
if(!function_exists('st_form_book_func'))
{
    ...
    add_shortcode('st_form_book','st_form_book_func');
}
...
if(!function_exists('st_excerpt_activity_func'))
{
    ...
    add_shortcode('st_excerpt_activity','st_excerpt_activity_func');
}
...
if(!function_exists('st_activity_content_func'))
{
    ...
    add_shortcode('st_activity_content','st_activity_content_func');
}
...
add_shortcode('st_activity_detail_map','st_activity_detail_map');
...
add_shortcode('st_activity_detail_review_summary','st_activity_detail_review_summary');
...
add_shortcode('st_activity_detail_review_detail','st_activity_detail_review_detail');
...
add_shortcode('st_activity_review','st_activity_review');
...
add_shortcode('st_activity_video','st_activity_video');
...
add_shortcode('st_activity_nearby','st_activity_nearby');