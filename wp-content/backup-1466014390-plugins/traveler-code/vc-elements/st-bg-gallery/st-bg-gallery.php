<?php
vc_map( array(
    "name" => __("ST Search with background gallery", STP_TEXTDOMAIN),
    "base" => "st_bg_gallery",
    ...
    "params" => array(
        array(
            "type" => "attach_images",
            "holder" => "div",
            "heading" => __("Images in", STP_TEXTDOMAIN),
        ...
        array(
            "type" => "textfield",
            "holder" => "div",
            "heading" => __("Effect Speed", STP_TEXTDOMAIN),
            "param_name" => "st_speed",
            "description" =>__('Example : 1200ms',STP_TEXTDOMAIN),
        ...
        array(
            "type" => "textfield",
            "holder" => "div",
            "heading" => __("Columns", STP_TEXTDOMAIN),
            "param_name" => "st_col",
            "description" =>__('Example : 8',STP_TEXTDOMAIN),
            'edit_field_class'=>'vc_col-sm-6',
            'value'=>'8'
        ),
        array(
            "type" => "textfield",
            "holder" => "div",
            "heading" => __("Rows", STP_TEXTDOMAIN),
            "param_name" => "st_row",
            "description" =>__('Example : 4',STP_TEXTDOMAIN),
            'edit_field_class'=>'vc_col-sm-6',
            'value'=>'4'
        ),
...
Class st_bg_gallery extends STBasedShortcode{
