<?php
vc_map( array(
    "name" => __("ST Testimonial", STP_TEXTDOMAIN),
    "base" => "st_testimonial",
    ...
    "params" => array(
        ...
        array(
            "type" => "colorpicker",
            "holder" => "div",
            "heading" => __("Text Color", STP_TEXTDOMAIN),
            "param_name" => "st_color",
            "description" =>"",
            'edit_field_class'=>'vc_col-sm-4',
        ),
        array(
            "type" => "dropdown",
            "holder" => "div",
            "heading" => __("Testimonial color", STP_TEXTDOMAIN),
            "param_name" => "st_testimonial_color",
            "description" =>"",
            'edit_field_class'=>'vc_col-sm-4',
            'value'=>array(
                __('No',STP_TEXTDOMAIN)=>'',
                __('Yes',STP_TEXTDOMAIN)=>'testimonial-color',
            )
        ),
        array(
            "type" => "textfield",
...
Class st_testimonial extends STBasedShortcode{
