...
vc_map(
    array(
        "name" => __("ST Slide Testimonial", STP_TEXTDOMAIN),
        "category"=>"Shinetheme",
        ...
        "params" => array(
            array(
                "type" => "textfield",
                "holder" => "div",
                "heading" => __("Speed", STP_TEXTDOMAIN),
                "param_name" => "st_speed",
                "description" =>__("Ex : 500ms",STP_TEXTDOMAIN),
                'value'=>'500'
            ),
            array(
                "type" => "textfield",
                "holder" => "div",
                "heading" => __("Auto Play Time", STP_TEXTDOMAIN),
                "param_name" => "st_play",
                "description" =>__("Set 0 to turn off autoplay",STP_TEXTDOMAIN),
                'value'=>'4500'
            ),
        )
    )
...
vc_map(
    array(
        "name" => __("Testimonial Item", STP_TEXTDOMAIN),
