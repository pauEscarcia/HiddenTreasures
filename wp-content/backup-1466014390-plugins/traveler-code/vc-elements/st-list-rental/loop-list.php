    ...
    <div class="thumb">
        ...
        <header class="thumb-header">
            <a class="hover-img" href="<?php the_permalink()?>">
                ...
                ?>
                <h5 class="hover-title-center"><?php _e('Book Now',STP_TEXTDOMAIN)?></h5>
            </a>
        </header>
        <div class="thumb-caption">
            ...
            <div>
                ...
                <?php
                if(!empty($price)){
                    echo '<span class="text-darken mb0 text-color">'.TravelHelper::format_money($price_sale).'<small> /'.__('night',STP_TEXTDOMAIN).'</small></span>';
                }
                ?>
            </div>
        </div>
