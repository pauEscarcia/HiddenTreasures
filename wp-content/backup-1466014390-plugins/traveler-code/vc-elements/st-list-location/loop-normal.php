                ...
                <a class="hover-img" href="<?php echo home_url(esc_url('?s=&post_type='.$st_type.'&location_id='.get_the_ID())) ?>">
                    ...
                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
                        ...
                        if($st_show_logo == 'yes' && !empty($img)){
                            ?>
                            <div class="img-<?php echo $st_logo_position ?>">
                                <img title="logo" alt="logo" src="<?php echo $img ?>">
                            </div>
                        <?php } ?>
                        <div class="text-small img-left">
                            ...
                            <?php if(!empty($review)){ ?>
                                <p>
                                    ...
                                    <?php if($review > 1) _e('reviews',STP_TEXTDOMAIN); else _e('review',STP_TEXTDOMAIN); ?>
                                </p>
                            <?php } ?>
                            <?php  if(!empty($offer)){ ?>
                                <p class="mb0">
                                    <?php echo esc_html($offer) ?>
                                    <?php if($review > 1) _e('offers',STP_TEXTDOMAIN); else _e('offer',STP_TEXTDOMAIN);   ?>
                                    <?php _e('from',STP_TEXTDOMAIN); ?>
