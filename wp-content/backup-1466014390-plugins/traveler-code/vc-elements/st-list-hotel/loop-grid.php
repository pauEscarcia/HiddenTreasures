                ...
                <a class="hover-img" href="<?php the_permalink()?>">
                    ...
                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
                        <div class="text-small">
                            <h5><?php the_title()?></h5>
                            <p><?php comments_number(__('no review',STP_TEXTDOMAIN),__('1 review',STP_TEXTDOMAIN),__('% reviews',STP_TEXTDOMAIN))  ?></p>
                            <?php
                            $count_offer=100;
                            ...
                            ?>
                                <p class="mb0"><?php printf(_n('%s offer','%s offers',$count_offer,STP_TEXTDOMAIN),$count_offer);
                                    printf(__(' from %s',STP_TEXTDOMAIN),TravelHelper::format_money($min_price))
                                    ?></p>
                            <?php endif;?>
                        </div>
                    </div>
